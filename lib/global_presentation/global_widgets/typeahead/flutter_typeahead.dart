...
import 'package:hessa_student/global_presentation/global_widgets/typeahead/should_refresh_suggestion_focus_index_notifier.dart';
...
class _SuggestionsListState<T> extends State<_SuggestionsList<T>>
  ...
  @override
  Widget build(BuildContext context) {
    bool isEmpty = _suggestions != null &&
