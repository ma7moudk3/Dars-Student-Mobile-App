...
class CustomizedSnackBar extends StatefulWidget {
  const CustomizedSnackBar.success({
    Key? key,
  ...
  const CustomizedSnackBar.error({
    Key? key,
    required this.message,
    this.messagePadding = const EdgeInsets.symmetric(horizontal: 24),
    this.icon = const Icon(
  ...
  @override
  CustomizedSnackBarState createState() => CustomizedSnackBarState();
}

class CustomizedSnackBarState extends State<CustomizedSnackBar> {
  @override
