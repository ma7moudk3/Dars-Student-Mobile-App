...
import 'package:hessa_student/app/modules/order_details/widgets/studying_package_order_dars_status_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GetX<OrderDetailsController>(
      ...
      OrderStatus orderStatus = OrderStatus.values[
          controller.darsOrderDetails.value.result?.order?.currentStatusId ??
              0];
      ...
      return Column(
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                StudyingPackageOrderDarsStatus(
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      PrimaryButton(
                        isDisabled: controller.darsOrderDetails.value.result
