                        ...
                        Column(
                          children: [
                            PasswordTextField(
                              ...
                              prefixIcon: Icon(
                                Icons.lock_outline,
                                color: controller.oldPasswordFocusNode.hasFocus
                                    ? controller.oldPasswordErrorIconColor ??
                              ...
                              validator: (String? oldPassword) =>
                                  controller.validateOldPassword(oldPassword),
                            ),
                            SizedBox(height: 20.h),
                            PasswordTextField(
                              titleFontSize: 14.sp,
                              ...
                              prefixIcon: Icon(
                                ...
                                color: controller.newPasswordFocusNode.hasFocus
                                    ? controller.newPasswordErrorIconColor ??
                                        ColorManager.primary
                                    : ColorManager.grey,
                                size: 23.w,
                              ),
                              ...
                              validator: (String? newPassword) =>
                                  controller.validateNewPassword(newPassword),
                            ),
                            SizedBox(height: 20.h),
                            PasswordTextField(
                              titleFontSize: 14.sp,
                              ...
                              validator: (String? confirmPassword) => controller
                                  .validateConfirmNewPassword(confirmPassword),
                            ),
                          ],
                        ),
                        const Spacer(),
